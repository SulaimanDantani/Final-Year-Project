                        ...
                        <div class="container-fluid">
                           ...
                           <form action="" id="request-form">
                               ...
                               <div class="form-group col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm rounded-0" name="contact" id="contact" required="required" oninput="validateContact(this)">
                                </div>
...
<script>
    ...
    function validateContact(input) {
        ...
        if (contactValue.length > 11 || !numericRegex.test(contactValue)) {
            input.value = contactValue.slice(0, 11); // Truncate to 11 digits
        }
    }
